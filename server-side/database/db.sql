...
-- VALUES  
-- (1,"SOFA"),(2,"COFFEE TABLE"),(3,"DINNER TABLE"), (4,"SIDEBOARD");
...
-- VALUES  
-- (1,1,500,3,8,"Sofa Blue","Leather blue sofa, 4 seater"),(2,1,100,3,8,"Sofa Grey","Fabric grey sofa, 4 seater"),(3,2,100,3,8,"Coffee Table Wood","Wood coffee table, 110cm Width x 25cm Height"),(4,2,300,3,8,"Coffee Table Solid Elm and Metal","Solid elm and metal coffee table, 140cm Width x 35cm Height"),(5,3,600,3,8,"Dinner Table Marbel","Marbel dinner table, size 6 people"),(6,3,100,3,8,"Dinner Table Solid Oak","Solid Oak Dinner Table, size 6 people"),(7,4,200,3,8,"Sideboard Oak","Oak sideboard, 118cm Width x 80cm Height"),(8,4,250,3,8,"Sideboard Glass","Sideboard with glass, 100cm Width x 88cm Height");
